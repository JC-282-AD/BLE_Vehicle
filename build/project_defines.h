...
#define DTM_RX_SCHEDULING 1
#define HCI_TR_EXACTLE 1
#define INIT_ENCRYPTED 1
#define INIT_PERIPHERAL 1
#define LCTR_CONN_NO_TIFS_REASSEMBLY 1
#define LL_WW_RX_DEVIATION_USEC 16
#define PAL_MAX_RTC_COUNTER_VAL 0xFFFFFFFF
...
#define UART_HWFC 0
#define WSF_ASSERT_ENABLED 1
#define WSF_BUF_FREE_CHECK_ASSERT 1
#define WSF_BUF_STATS 1
#define WSF_CS_STATS 1
#define WSF_TRACE_ENABLED 1
#define uECC_ASM 2
#define __CORDIO__ 1
#define APP_CODED_PHY_DEMO 0
